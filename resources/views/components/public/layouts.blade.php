...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    ...
    <flux:header sticky container class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item href="{{ route('posts') }}" :current="request()->routeIs('posts')">{{ __('Posts') }}</flux:navbar.item>
    ...
    <div class="flex min-h-screen">
        ...
        @if(request()->routeIs('posts'))
            <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700 w-64">
