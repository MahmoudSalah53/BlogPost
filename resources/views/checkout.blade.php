<x-public.layouts :title="__('Checkout')">
    <div class="min-h-screen bg-gradient-to-br from-zinc-50 via-slate-50 to-zinc-100 dark:from-zinc-900 dark:via-slate-900 dark:to-zinc-800 py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-center">
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-fuchsia-600 dark:to-purple-600 rounded-full flex items-center justify-center text-white font-bold">1</div>
                            <span class="ml-2 text-sm font-medium text-zinc-600 dark:text-zinc-300">Plan Selection</span>
                        </div>
                        <div class="w-16 h-1 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-fuchsia-600 dark:to-purple-600 rounded-full"></div>
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-fuchsia-600 dark:to-purple-600 rounded-full flex items-center justify-center text-white font-bold">2</div>
                        ...
                        <div class="flex items-center">
                            <div class="w-10 h-10 bg-zinc-300 dark:bg-zinc-600 rounded-full flex items-center justify-center text-zinc-600 dark:text-zinc-400 font-bold">3</div>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                        <!-- Header -->
                        <div class="px-8 py-6 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-fuchsia-900/20 dark:to-purple-900/20 border-b border-zinc-200 dark:border-zinc-700">
                        ...
                        <div class="p-8">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div class="relative">
                                        <input type="radio" id="card" name="payment-method" class="peer sr-only" checked>
                                        <label for="card" class="flex items-center justify-center p-4 bg-white dark:bg-zinc-700 border-2 border-zinc-200 dark:border-zinc-600 rounded-xl cursor-pointer peer-checked:border-amber-500 dark:peer-checked:border-fuchsia-500 peer-checked:bg-amber-50 dark:peer-checked:bg-fuchsia-900/20 transition-all hover:shadow-md">
                                            <div class="text-center">
                                                <div class="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg flex items-center justify-center">
                                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                        <path d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2h12v2H4V6zm0 4h4v2H4v-2z"/>
                                                    </svg>
                                                </div>
                                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Credit Card</span>
                                            </div>
                                        </label>
                                    </div>
                                    <div class="relative">
                                        <input type="radio" id="paypal" name="payment-method" class="peer sr-only">
                                        <label for="paypal" class="flex items-center justify-center p-4 bg-white dark:bg-zinc-700 border-2 border-zinc-200 dark:border-zinc-600 rounded-xl cursor-pointer peer-checked:border-amber-500 dark:peer-checked:border-fuchsia-500 peer-checked:bg-amber-50 dark:peer-checked:bg-fuchsia-900/20 transition-all hover:shadow-md">
                                            <div class="text-center">
                                                <div class="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg flex items-center justify-center">
                                    ...
                                    <div class="relative">
                                        ...
                                        <label for="apple-pay" class="flex items-center justify-center p-4 bg-white dark:bg-zinc-700 border-2 border-zinc-200 dark:border-zinc-600 rounded-xl cursor-pointer peer-checked:border-amber-500 dark:peer-checked:border-fuchsia-500 peer-checked:bg-amber-50 dark:peer-checked:bg-fuchsia-900/20 transition-all hover:shadow-md">
                                            <div class="text-center">
                                                <div class="w-8 h-8 mx-auto mb-2 bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg flex items-center justify-center">
                                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                                        <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                                                    </svg>
                                                </div>
                                                <span class="text-sm font-medium text-zinc-700 dark:text-zinc-300">Apple Pay</span>
                                            </div>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6">
                        ...
                        <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-700 overflow-hidden mb-6">
                            <div class="px-6 py-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-fuchsia-900/20 dark:to-purple-900/20 border-b border-zinc-200 dark:border-zinc-700">
                            ...
                            <div class="p-6">
                                @if(session('plan'))
                                    <!-- Selected Plan -->
                                    <div class="flex items-start space-x-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-fuchsia-900/10 dark:to-purple-900/10 rounded-xl border border-amber-200 dark:border-fuchsia-800">
                                        <div class="w-12 h-12 bg-gradient-to-r from-amber-500 to-orange-500 dark:from-fuchsia-600 dark:to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                                            </svg>
                                        </div>
                                        <div class="flex-1">
                                            <h4 class="font-semibold text-zinc-900 dark:text-white">{{ session('plan.name') }} Plan</h4>
                                            <p class="text-sm text-zinc-600 dark:text-zinc-300">30 Days Access</p>
                                        </div>
                                        <div class="text-right">
                                            <div class="text-lg font-bold text-zinc-900 dark:text-white">${{ session('plan.price') }}</div>
                                        </div>
                                    </div>
                                ...
                                @else
                                    <div class="text-center py-8">
                                        ...
                                        <button class="mt-4 text-amber-600 dark:text-fuchsia-400 hover:underline text-sm font-medium">
                                            Select a plan
                                        </button>
                                    </div>
                                @endif
