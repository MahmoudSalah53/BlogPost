    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 my-5">
        ...
        <div class="relative">
            <div class="flex overflow-x-auto gap-6 pb-6 -mx-4 px-4 scrollbar-hide">
                ...
                <!-- Post 1 -->
                <div
                    class="min-w-[300px] bg-white dark:bg-zinc-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-5 flex-shrink-0 border border-gray-100 dark:border-zinc-700">
                    ...
                    <flux:text class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Exploring New
                        Frontiers
                    </flux:text>
                    ...
                    <div class="flex justify-between items-center">
                        <flux:link href="#"
                                   class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium flex items-center">
                            Read More
                        </flux:link>
                ...
                <div
                    ...
                    <flux:text class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Nature's Wonders
                    </flux:text>
                    <flux:text class="text-gray-600 dark:text-gray-300 line-clamp-3 mb-4">
                        Discover the latest trends in technology and how they're shaping our future...
                    </flux:text>
                ...
                <div
                    ...
                    <flux:text class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Urban Exploration
                    </flux:text>
                    <flux:text class="text-gray-600 dark:text-gray-300 line-clamp-3 mb-4">
                        Discover the latest trends in technology and how they're shaping our future...
                    </flux:text>
                ...
                <div
                    ...
                    <flux:text class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Culinary Adventures
                    </flux:text>
                    <flux:text class="text-gray-600 dark:text-gray-300 line-clamp-3 mb-4">
                        Discover the latest trends in technology and how they're shaping our future...
                    </flux:text>
                ...
                <div
                    ...
                    <flux:text class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Digital Nomad Life
                    </flux:text>
                    <flux:text class="text-gray-600 dark:text-gray-300 line-clamp-3 mb-4">
                        Discover the latest trends in technology and how they're shaping our future...
                    </flux:text>
