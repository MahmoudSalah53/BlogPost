<div class="mt-10 border-t border-zinc-300 dark:border-zinc-600 pt-8">
    ...
    @else
    <flux:text size="lg" class="mt-6 text-zinc-800 dark:text-white text-center">
        You need to
        <a
            href="{{ route('login') }}"
            wire:navigate

            class="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300 transition">
            log in
        </a>
        to comment.
    </flux:text>
